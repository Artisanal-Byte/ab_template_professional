...
<template>
    ...
    >
        ...
        >
            <main
                class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg border border-border bg-card text-card-foreground shadow-sm lg:max-w-4xl lg:flex-row"
            >
                <div
                ...
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            <span
                                class="relative bg-card py-1"
                            >
                                <span
                                    class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-border bg-background shadow-sm"
                                >
                                    <span
                            ...
                            <span>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-primary underline underline-offset-4"
                                >
